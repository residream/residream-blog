...
![C++ 程序的组成：实现文件、头文件、外部库、资源文件、数据文件等经 make 等工具编译为可执行文件](./images/image-20260602130507403-3.png)
...
![C++ 构建流程：源文件与头文件经预编译、编译得到 .obj，资源文件编译为 .res，再与库文件链接成 myapp.exe](./images/image-20260602131355647-3.png)
